...
set path=%MAVEN_HOME%\bin;%JAVA_HOME%\bin;%MYSQL_HOME%\bin;%PGSQL_HOME%\bin;%SVN_HOME%\bin;%APP_HOME%\dostools;%APACHE_HOME%\bin;%FREE_COMMANDER_HOME%\tools\vim\vim72;%WORK_HOME%;%path%
